...
const getMintInfo = async (connection, pubKey) => {
    ...
    return (0, exports.deserializeMint)(data);
};
const MintParser = (pubKey, info) => {
    const buffer = Buffer.from(info.data);
    const data = (0, exports.deserializeMint)(buffer);
    const details = {
        pubkey: pubKey,
        account: {
            ...info,
...
exports.cache = {
    ...
    addMint: (pubKey, obj) => {
        const mint = (0, exports.deserializeMint)(obj.data);
        ...
        if (!connection || !publicKey) {
            ...
            const tokenSubID = connection.onProgramAccountChange((0, programIds_1.programIds)().token, info => {
                ...
                if (info.accountInfo.data.length === spl_token_1.AccountLayout.span) {
                    const data = (0, exports.deserializeAccount)(info.accountInfo.data);
